Elements = (
    ...
    Beryllium =
        Element(4, "Be", "Beryllium", 0.44384, 63.7eV, 1.848E+00g / cm^3),
    ...
    Magnesium =
        Element(12, "Mg", "Magnesium", 0.49373, 156.0eV, 1.740E+00g / cm^3),
    Aluminum =
        Element(13, "Al", "Aluminum", 0.48181, 166.0eV, 2.699E+00g / cm^3),
    Silicon = Element(14, "Si", "Silicon", 0.49848, 173.0eV, 2.330E+00g / cm^3),
    Phosphorus =
        Element(15, "P", "Phosphorus", 0.48428, 173.0eV, 2.200E+00g / cm^3),
    Sulfur = Element(16, "S", "Sulfur", 0.49897, 180.0eV, 2.000E+00g / cm^3),
    Chlorine =
        Element(17, "Cl", "Chlorine", 0.47951, 174.0eV, 2.995E-03g / cm^3),
    Argon = Element(18, "Ar", "Argon", 0.45059, 188.0eV, 1.662E-03g / cm^3),
    Potassium =
        Element(19, "K", "Potassium", 0.48595, 190.0eV, 8.620E-01g / cm^3),
    Calcium = Element(20, "Ca", "Calcium", 0.49903, 191.0eV, 1.550E+00g / cm^3),
    Scandium =
        Element(21, "Sc", "Scandium", 0.46712, 216.0eV, 2.989E+00g / cm^3),
    Titanium =
        Element(22, "Ti", "Titanium", 0.45948, 233.0eV, 4.540E+00g / cm^3),
    Vanadium =
        Element(23, "V", "Vanadium", 0.45150, 245.0eV, 6.110E+00g / cm^3),
    Chromium =
        Element(24, "Cr", "Chromium", 0.46157, 257.0eV, 7.180E+00g / cm^3),
    Manganese =
        Element(25, "Mn", "Manganese", 0.45506, 272.0eV, 7.440E+00g / cm^3),
    ...
    Germanium =
        Element(32, "Ge", "Germanium", 0.44071, 350.0eV, 5.323E+00g / cm^3),
    Arsenic = Element(33, "As", "Arsenic", 0.44046, 347.0eV, 5.730E+00g / cm^3),
    Selenium =
        Element(34, "Se", "Selenium", 0.43060, 348.0eV, 4.500E+00g / cm^3),
    ...
    Rubidium =
        Element(37, "Rb", "Rubidium", 0.43291, 363.0eV, 1.532E+00g / cm^3),
    Strontium =
        Element(38, "Sr", "Strontium", 0.43369, 366.0eV, 2.540E+00g / cm^3),
    Yttrium = Element(39, "Y", "Yttrium", 0.43867, 379.0eV, 4.469E+00g / cm^3),
    Zirconium =
        Element(40, "Zr", "Zirconium", 0.43848, 393.0eV, 6.506E+00g / cm^3),
    ...
    Ruthenium =
        Element(44, "Ru", "Ruthenium", 0.43534, 441.0eV, 1.241E+01g / cm^3),
    Rhodium = Element(45, "Rh", "Rhodium", 0.43729, 449.0eV, 1.241E+01g / cm^3),
    Palladium =
        Element(46, "Pd", "Palladium", 0.43225, 470.0eV, 1.202E+01g / cm^3),
    ...
    Antimony =
        Element(51, "Sb", "Antimony", 0.41889, 487.0eV, 6.691E+00g / cm^3),
    Tellurium =
        Element(52, "Te", "Tellurium", 0.40752, 485.0eV, 6.240E+00g / cm^3),
    ...
    Lanthanum =
        Element(57, "La", "Lanthanum", 0.41035, 501.0eV, 6.154E+00g / cm^3),
    ...
    Neodymium =
        Element(60, "Nd", "Neodymium", 0.41597, 546.0eV, 6.900E+00g / cm^3),
    Promethium = Element(
        61,
        "Pm",
        "Promethium",
    ...
    Samarium =
        Element(62, "Sm", "Samarium", 0.41234, 574.0eV, 7.460E+00g / cm^3),
    Europium =
        Element(63, "Eu", "Europium", 0.41457, 580.0eV, 5.243E+00g / cm^3),
    Gadolinium = Element(
        64,
        "Gd",
        "Gadolinium",
    ...
    Ytterbium =
        Element(70, "Yb", "Ytterbium", 0.40453, 684.0eV, 6.730E+00g / cm^3),
    Lutetium =
        Element(71, "Lu", "Lutetium", 0.40579, 694.0eV, 9.840E+00g / cm^3),
    Hafnium = Element(72, "Hf", "Hafnium", 0.40338, 705.0eV, 1.331E+01g / cm^3),
    Tantalum =
        Element(73, "Ta", "Tantalum", 0.40343, 718.0eV, 1.665E+01g / cm^3),
    Tungsten =
        Element(74, "W", "Tungsten", 0.40250, 727.0eV, 1.930E+01g / cm^3),
